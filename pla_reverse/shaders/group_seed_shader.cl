...
inline bool verify(__global ulong *fixed_seeds, const int fixed_seeds_length,
                   ulong generator_seed) {
  struct xoroshiro rng = {generator_seed - 0x82A2B175229D6A5B,
                          0x82A2B175229D6A5B};
...
__kernel void find_group_seed(__global ulong *results,
                              __global ulong *generator_seeds,
                              __global ulong *fixed_seeds,
                              const int fixed_seeds_length) {

...
__kernel void find_generator_seeds(
    __global uint *cnt,
    __global ulong *res_g,
...
)
{
    ...
    unsigned long x0_slice = x0_from_x1(x1_slice) & 0b0011100000111000001110000011100000111000001110000011100000111000;
    unsigned long sub = random - x0_slice - x1_slice;
    unsigned long base_x1_slice_3 = sub & 0b0000100000001000000010000000100000001000000010000000100000001000;
    unsigned long sub_carry = sub - 0b1100000011000000110000001100000011000000110000001100000011000000;
                    ...
                    for (unsigned long i4 = 0; i4 <= ((changed >> 43) & 1); i4++) {
                        ...
                        for (unsigned long i5 = 0; i5 <= ((changed >> 51) & 1); i5++) {
                            ...
                            for (unsigned long i6 = 0; i6 <= ((changed >> 59) & 1); i6++) {
                                ...
                                unsigned long x0_slice_3 = x0_from_x1(x1_slice_3) & 0b0100000001000000010000000100000001000000010000000100000001000000;
                                unsigned long x0_slice_ = x0_slice | x0_slice_3;
                                unsigned long x1_slice_ = x1_slice | x1_slice_3;
                                unsigned long x1_slice_4 = (random - x0_slice_ - x1_slice_) & 0b0001000000010000000100000001000000010000000100000001000000010000;
                                unsigned long x0_slice_4 = x0_from_x1(x1_slice_4) & 0b1000000010000000100000001000000010000000100000001000000010000000;
                                x0_slice_ = x0_slice_ | x0_slice_4;
                                x1_slice_ = x1_slice_ | x1_slice_4;
                                unsigned long x1_slice_567 = (random - x0_slice_ - x1_slice_) & 0b1110000011100000111000001110000011100000111000001110000011100000;
                                unsigned long x0_slice_567 = x0_from_x1(x1_slice_567) & 0b0000011100000111000001110000011100000111000001110000011100000111;
